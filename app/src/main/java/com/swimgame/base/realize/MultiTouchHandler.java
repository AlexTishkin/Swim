...
// АНАЛОГ ОДИНОЧНОГО КАСАНИЯ!!!!!!!!!!!!!!!!!!!!!!
// Обработка множественных касаний
// Для Android выше версии 1.6
...
public class MultiTouchHandler implements TouchHandler {
    ...
    public MultiTouchHandler(View view, float scaleX, float scaleY) {
        Pool.PoolObjectFactory<Input.TouchEvent> factory = new
    ...
    @Override
    public boolean onTouch(View v, MotionEvent event) {                   // Обработка Мультитач
        synchronized (this) {
